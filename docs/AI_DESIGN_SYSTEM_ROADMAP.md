...
- raster-family structural scoring now also helps more distinctive non-OCR profile/document/editor/catalog/map/media/capture layouts resolve into the right semantic family without OCR text, and stronger settings/paywall ambiguity guards now block more weak profile/reward/commerce family overreads from filenames or terse notes alone
