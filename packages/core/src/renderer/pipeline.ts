  ...
  try {
    ...
    const tasks = renderTasks.map((task) => async (): Promise<RenderResult> => {
      ...
      const context: TemplateContext = {
        ...
        colors: {
          ...config.theme.colors,
          text: (screen as any).textColor ?? config.theme.colors.text,
          subtitle: (screen as any).subtitleColor ?? config.theme.colors.subtitle,
        },
        ...
        backgroundType: config.theme.backgroundType,
        backgroundColor: screen.background ?? config.theme.backgroundColor,
        backgroundGradient: config.theme.backgroundGradient,
        backgroundOverlay: config.theme.backgroundOverlay,
